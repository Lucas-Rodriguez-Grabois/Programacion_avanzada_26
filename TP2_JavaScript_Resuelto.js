...
console.log(autenticarUsuario({ usuario: "admin", contrasenia: "1234" }));
console.log(autenticarUsuario({ usuario: "admin", contrasenia: "otra" }));
...
console.log(validarFormulario({ nombre: "", email: "ana@mail.com", password: "" }));
...
console.log(obtenerPagina(datosEjemplo, 2));
...
console.log(filtrarMayoresDe([3, 8, 1, 12, 6], 5));
